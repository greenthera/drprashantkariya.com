        ...
        */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:grid-rows-3 gap-5">
          ...
          <motion.div
            ...
            className="md:col-span-1 lg:col-span-2 bg-white rounded-2xl p-7 md:p-8 border border-[#E0E8E2] hover:border-[#D6DBF5] hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden flex flex-col sm:flex-row items-start gap-6"
          >
            <div className="absolute bottom-0 right-4 font-display text-[7rem] leading-none font-bold text-[#2E3A9E]/4 select-none pointer-events-none translate-y-2">
              02
            </div>
            <div className="w-12 h-12 bg-[#EAEDFB] rounded-xl flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-300 mt-1">
          ...
          <motion.div
            ...
            className="bg-white rounded-2xl p-7 border border-[#E0E8E2] hover:border-[#D6DBF5] hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden"
          >
            <div className="absolute top-0 right-2 font-display text-[7rem] leading-none font-bold text-[#2E3A9E]/4 select-none pointer-events-none -translate-y-2">
              03
            </div>
            <div className="w-11 h-11 bg-[#EAEDFB] rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300">
              <Droplet size={20} className="text-[#4353CF]" />
            </div>
          ...
          >
            ...
            <div className="w-11 h-11 bg-[#EAEDFB] rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300">
              <Microscope size={20} className="text-[#4353CF]" />
            </div>
            <h3 className="font-display text-xl md:text-2xl font-bold italic text-[#2E3A9E] mb-2 leading-tight">
          ...
          <motion.div
            ...
            className="md:col-span-2 lg:col-span-2 bg-white lg:bg-[#EAEDFB] rounded-2xl p-7 md:p-8 border border-[#D6DBF5] hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden flex flex-col sm:flex-row items-start gap-6"
          >
            <div className="absolute bottom-0 right-4 font-display text-[7rem] leading-none font-bold text-[#4353CF]/8 select-none pointer-events-none translate-y-2">
              05
            </div>
          ...
          >
            ...
            <div className="w-11 h-11 bg-[#EAEDFB] rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300">
              <Heart size={20} className="text-[#4353CF]" />
            </div>
            <h3 className="font-display text-xl md:text-2xl font-bold italic text-[#2E3A9E] mb-2 leading-tight">
