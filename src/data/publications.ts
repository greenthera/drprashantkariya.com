...
export const PublicationsData = [
  {
    ...
    "title": "Indian Academy of Pediatrics Consensus Guidelines on Preconception Care",
  ...
  {
    image: publications_two,
    "title": "Development and Formative Assessment of an Innovative Blended Educational Course for Care of Small and Sick Neonates in India and SEARO Countries",
  ...
  },
  {
    ...
    "title": "Medical Science: Recent Advances and Applications Vol. 3",
  ...
  },
  {
    ...
    "title": "Study of Resilience in Female College Adolescents and Young Adults: Tough Times Don’t Last, Tough People Do",
  ...
  {
    image: publications_four,
    "title": "Analysis Of Impact Of Regular Formative Assessment On Final Summative Assessment Among MBBS Students",
    "expert": "Evaluations in education should exhibit reliability, acceptability, and cost-effectiveness. Formative assessment aids in motivating and guiding students through effective feedback, thereby enhancing learning outcomes. Consistent formative assessments have been shown to enhance performance in summative assessments. This study aimed to assess the impact of continuous formative assessment on summative assessment scores among first-year MBBS students.",
    "buttonurl": "https://kuey.net/index.php/kuey/article/view/1602"
  },
  {
    image: publications_four,
    "title": "Indian Journal of Youth and Adolescent Health Article View (2454)",
    "expert": "Advanced Research Publications",
    "buttonurl": "https://medical.advancedresearchpublications.com/index.php/IndianJ-YouthandAdolescentHeatlh/article/view/2454"
  },
  {
    image: publications_four,
    "title": "Prevalence and Correlates of Anxiety Disorders among Higher Secondary School Students: A Cross-Sectional Study",
    "expert": "To study the anxiety disorders among higher secondary school students using Screen for Child Anxiety Related Disorders (SCARED)",
  ...
  },
  {
    ...
    "expert": "Adolescents are susceptible to unhealthy practices due to a lack of knowledge and curiosity to try new things. Adolescent age also forms the base for behaviors throughout their lives. This study therefore aimed to understand adolescents’ present knowledge and attitude towards HIV/AIDS.",
  ...
  },
  {
    ...
    "expert": "Study background AACCI - Association of Adolescent and Child Care in India conducts multicentric youth behaviour studies in India. The results are shared with the school and intervention programs are held. This paper analyses the pattern of internet use knowledge and practices in school children",
  ...
  {
    image: publications_four,
    "title": "A Cross Sectional Study on Depression disorders among higher secondary school students using Beck Depression Inventory (BDI) in India",
  ...
  {
    image: publications_two,
    "title": "NEPTUNE Trial: Methodological Considerations and Unanswered Questions",
  ...
  {
    image: publications_four,
    "title": "The Urban Academic Stress Map: How Age, Gender, and City Influence Test Anxiety and Self-Esteem in Adolescents- A Multicentric Cross-Sectional Study Across Four Indian Cities",
